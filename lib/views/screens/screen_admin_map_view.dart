...
import 'package:one_life_admin/views/layouts/item_admin_organizer_event_list.dart';

import '../../helpers/helpers.dart';
import '../../widgets/asset_icon.dart';
class ScreenAdminMapView extends StatefulWidget {
  const ScreenAdminMapView({Key? key}) : super(key: key);

  @override
  _ScreenAdminMapViewState createState() => _ScreenAdminMapViewState();
}

class _ScreenAdminMapViewState extends State<ScreenAdminMapView> {
              ...
              child: Column(children: [
                ...
                Expanded(child: CustomListviewBuilder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return ItemAdminOrganizerEventList();
                  },
                ))
              ],),
            ),
