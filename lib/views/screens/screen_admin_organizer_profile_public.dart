...
import 'package:one_life_admin/views/screens/screen_admin_map_view.dart';

import '../../helpers/helpers.dart';
import '../../widgets/asset_icon.dart';

class ScreenAdminOrganizerProfilePublic extends StatefulWidget {
  const ScreenAdminOrganizerProfilePublic({Key? key}) : super(key: key);

  @override
  _ScreenAdminOrganizerProfilePublicState createState() =>
      _ScreenAdminOrganizerProfilePublicState();
}

class _ScreenAdminOrganizerProfilePublicState
    extends State<ScreenAdminOrganizerProfilePublic> {
  bool isChecked=true;
  int selectedIndex = 0;
                  ...
                  child: SingleChildScrollView(
                    ...
                    InkWell(
                      ...
                      Container(
                        ...
                        margin: EdgeInsets.symmetric(vertical: 5),
                        decoration: BoxDecoration(
                            color: Color(0xFF21A366).withOpacity(0.1),
                            borderRadius: BorderRadius.circular(10),
                            boxShadow: [BoxShadow(color: backGroundColorBlueLight,blurRadius: 5)]
                        ),
                        child: Row(children: [
                        Image.asset("assets/images/xcel.png"),
                          SizedBox(width: 1.h,),

                          Text("Export as .xl",style: TextStyle(fontWeight: FontWeight.w400,fontSize: 12,color: Color(0xFF21A366)),)
                      ],),),
                      Container(
                        padding: EdgeInsets.symmetric(vertical: 15,horizontal: 10),
                        margin: EdgeInsets.symmetric(vertical: 5),
                        ...
                        AssetIcon(path: "assets/svg/bag.svg"),
                          ...
                          Text("Delete this account",style: TextStyle(fontWeight: FontWeight.w400,fontSize: 12,color: backGroundColorPink),)
                      ],),),
                      Container(
                        padding: EdgeInsets.symmetric(vertical: 15,horizontal: 10),
                        margin: EdgeInsets.symmetric(vertical: 5),
                        ...
                        AssetIcon(path: "assets/svg/close.svg"),
                          ...
                          Text("Temporarily suspend ",style: TextStyle(fontWeight: FontWeight.w400,fontSize: 12,color: backGroundColorPink),)
                      ],),),
                ],),
                  ),),
              )
